...
function readBlobSync(blob, type) {
  ...
  var data = reader.readAsArrayBuffer(blob);
  return data;
}
...
var hasRequiredTypeson;
function requireTypeson() {
  if (hasRequiredTypeson) return typeson$1.exports;
  hasRequiredTypeson = 1;
  ...
  return typeson$1.exports;
}
var typesonExports = requireTypeson();
var Typeson = getDefaultExportFromCjs(typesonExports);
var structuredCloning$1 = { exports: {} };
var structuredCloning = structuredCloning$1.exports;
var hasRequiredStructuredCloning;
function requireStructuredCloning() {
  if (hasRequiredStructuredCloning) return structuredCloning$1.exports;
  hasRequiredStructuredCloning = 1;
  (function(module, exports$1) {
    !function(e, t) {
      module.exports = t();
    }(structuredCloning, function() {
      ...
      var s = function() {
        ...
        return function _createClass(e2, t2, r2) {
          ...
          function finish(e2) {
            ...
            if (n2.iterateNone) return t3.length ? t3[0] : Typeson2.getJSONType(e2);
            if (t3.length) {
  ...
  return structuredCloning$1.exports;
}
var structuredCloningExports = requireStructuredCloning();
var StructuredCloning = getDefaultExportFromCjs(structuredCloningExports);
...
var decode = function decode2(base64, options) {
  ...
  var arraybuffer = new ArrayBuffer(bufferLength, options), bytes = new Uint8Array(arraybuffer);
  for (var _i2 = 0; _i2 < len; _i2 += 4) {
    encoded1 = lookup[
      /** @type {number} */
      base64.codePointAt(_i2)
    ];
    encoded2 = lookup[
      /** @type {number} */
      base64.codePointAt(_i2 + 1)
    ];
    encoded3 = lookup[
      /** @type {number} */
      base64.codePointAt(_i2 + 2)
    ];
    encoded4 = lookup[
      /** @type {number} */
      base64.codePointAt(_i2 + 3)
    ];
...
TSON.finalize = function(items) {
  return __awaiter(void 0, void 0, void 0, function() {
    ...
    return __generator(this, function(_c) {
      switch (_c.label) {
        case 0:
          return [4, readBlobAsync(new Blob(blobsToAwait))];
        case 1:
          allChunks = _c.sent();
          if (items) {
...
var clarinet$1 = {};
var fakeStream;
var hasRequiredFakeStream;
function requireFakeStream() {
  if (hasRequiredFakeStream) return fakeStream;
  hasRequiredFakeStream = 1;
  fakeStream = { Stream: function() {
  } };
  return fakeStream;
}
var hasRequiredClarinet;
function requireClarinet() {
  if (hasRequiredClarinet) return clarinet$1;
  ...
  (function(exports$1) {
    (function(clarinet2) {
      ...
      clarinet2.MAX_BUFFER_LENGTH = 10 * 1024 * 1024;
      ...
      try {
        Stream = requireFakeStream().Stream;
      } catch (ex) {
        Stream = function() {
        };
      }
...
var clarinetExports = requireClarinet();
var clarinet = getDefaultExportFromCjs(clarinetExports);
function JsonStream(blob) {
  ...
  var rv = {
    pullAsync: function(numBytes) {
      return __awaiter(this, void 0, void 0, function() {
        var slize, buf, jsonPart, result;
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              slize = blob.slice(pos, pos + numBytes);
              pos += numBytes;
              return [4, readBlobAsync(slize)];
            case 1:
              buf = _a.sent();
              jsonPart = decoder.decode(buf, { stream: pos < blob.size });
    ...
    pullSync: function(numBytes) {
      ...
      pos += numBytes;
      var buf = readBlobSync(slize);
      var jsonPart = decoder.decode(buf, { stream: pos < blob.size });
